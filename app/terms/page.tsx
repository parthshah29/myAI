      ...
      <div className="w-full max-w-screen-md space-y-6">
        ...
        <ol className="list-decimal list-inside space-y-4">
          <li className="text-gray-700">
            ...
            accessing and using the AI chatbot ("Chatbot, Snowflake") provided by Parth Shah
          ...
          <li className="text-gray-700">
            ...
            or implied. Parth Shah makes no representations or warranties regarding
          ...
          <li className="text-gray-700">
            ...
            Parth Shah does not guarantee that the Chatbot will be available at all
          ...
          <li className="text-gray-700">
            ...
            the fullest extent permitted by applicable law, Parth Shah shall not be
            ...
            Parth Shah has been advised of the possibility of such damages.
          </li>
          <li className="text-gray-700">
            <span className="font-semibold">
          ...
          <li className="text-gray-700">
            ...
            decisions made based on its output. Parth Shah is not responsible for any
          ...
          <li className="text-gray-700">
            ...
            considered equivalent to public postings, and Parth Shah does not
          ...
          <li className="text-gray-700">
            ...
            indemnify, defend, and hold harmless Parth Shah from any claims,
            liabilities, damages, losses, and expenses, including reasonable
            legal fees, arising from your use of the Chatbot or violation of
            these Terms of Use.
          </li>
          <li className="text-gray-700">
            <span className="font-semibold">Modifications to Terms:</span> Parth Shah
          ...
          <li className="text-gray-700">
            ...
            contact Parth Shah at parths29@gmail.com.
          </li>
        </ol>
      </div>
    </div>
